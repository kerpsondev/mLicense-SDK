...
import pl.kerpson.license.utilites.modules.impl.license.basic.LicenseImpl.BuilderImpl;
import pl.kerpson.license.utilites.modules.impl.license.basic.LicenseImpl.KeyGenerator;

public interface License extends ModuleObject {
  ...
  interface Builder {
    ...
    Builder setAddons(@NotNull List<Long> addons);
